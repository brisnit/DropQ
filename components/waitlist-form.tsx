  ...
  return (
    <form action={formAction} className="bg-paper border border-line rounded-card p-6 space-y-3">
      ...
      <label className="flex items-start gap-2.5 text-sm text-ink-soft">
        <input type="checkbox" name="optIn" defaultChecked className="mt-0.5 w-4 h-4 accent-[#ff934b]" />
        <span>Yes, notify me about future drops by email{" "}{/* */}and/or text. I can opt out anytime.</span>
      </label>
      {geofence && (
        <label className="flex items-start gap-2.5 text-sm text-ink-soft">
          <input type="checkbox" name="optInGeofence" className="mt-0.5 w-4 h-4 accent-[#ff934b]" />
