        ...
        {loc && !editingLoc ? (
          ...
          <div className="bg-paper border border-line rounded-card p-5">
            ...
            <form onSubmit={searchZip} className="flex gap-2">
              ...
              />
              <button type="submit" className="inline-flex items-center justify-center min-h-11 text-sm font-semibold rounded-xl px-4 bg-brand text-white hover:bg-brand-dark transition">
                Search
              </button>
            </form>
          </div>
      ...
      <div className="mt-6 flex gap-2 overflow-x-auto pb-1 -mx-5 px-5 sm:justify-center sm:flex-wrap">
        {FILTERS.map((f) => (
          <button
            ...
            className={`shrink-0 text-sm font-medium inline-flex items-center min-h-11 px-3.5 py-1.5 rounded-pill border transition ${
