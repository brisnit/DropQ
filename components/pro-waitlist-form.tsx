...
function Submit() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="shrink-0 inline-flex items-center justify-center min-h-11 rounded-lg bg-ink text-cream text-sm font-medium px-3.5 py-2 hover:bg-ink-soft transition disabled:opacity-50"
    >
      {pending ? "…" : "Notify me"}
    </button>
  );
